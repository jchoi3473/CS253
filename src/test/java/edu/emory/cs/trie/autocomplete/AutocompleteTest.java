...
public class AutocompleteTest {
    ...
    public void test() {
        ...
        Autocomplete<?> ac = new AutocompleteChoi2(dict_file, max);
        Eval eval = new Eval();
...
/*
abaz,abac,abas,abae,abak,abaa,abaq,abam,abay,aba,abal,abap,abao,abav,abab,abah,abaj,abag*/
        prefix = "aba";
        expected = List.of("aba", "abaa", "abab", "abac", "abae", "abag", "abah", "abaj", "abak", "abal");
        ...
        prefix = "aba";
        expected = List.of("abac", "aba", "abaa", "abab", "abae", "abag", "abah", "abaj", "abak", "abal");
        ac.pickCandidate(prefix, "abac");
        testGetCandidates(ac, eval, prefix, expected);
