...
public class AutocompleteChoi4 extends Autocomplete<List<String>> {
    List<String> result ;
    Queue<String> stringQueue ;
    Queue<TrieNode<List<String>>> nodeQueue;
    TrieNode<List<String>> node;

    public AutocompleteChoi4(String dict_file, int max) {
        super(dict_file, max);
    }
...
/* Testing main method
    public static void main(String[] args) {
        ...
        AutocompleteChoi4 tmp = new AutocompleteChoi4(dict_path,30000);
