...
public class AutocompleteChoiExtra extends Autocomplete<List<List<String>>> {
    List<String> result ;
    Queue<String> stringQueue ;
    Queue<TrieNode<List<List<String>>>> nodeQueue;
    TrieNode<List<List<String>>> node;

    public AutocompleteChoiExtra(String dict_file, int max) {
        super(dict_file, max);
    }
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        AutocompleteChoiExtra tmp = new AutocompleteChoiExtra(dict_path,400000);
